...
namespace Hybridizer.Basic.Utilities
{
    public static class RandomExtension
    {
        ...
        {
            return float4.make_float4(a.NextFloat(min, max), a.NextFloat(min, max), a.NextFloat(min, max), a.NextFloat(min, max));
        }

        public static float2 NextFloat2(this Random a, float min = 0.0f, float max = 1.0f)
        {
            return float2.make_float2(a.NextFloat(min, max), a.NextFloat(min, max));
        }
    }
